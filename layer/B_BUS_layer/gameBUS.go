...
func ReadGamesByUserBUS(id string) []DTO.Game {
	games := C_DAO_layer.ReadGamesByUserDAO(id)
	return games
}
...
func SearchGameBUS(id, key_name string) []DTO.Game {
	games := C_DAO_layer.SearchGameDAO(id, key_name)
	return games
}